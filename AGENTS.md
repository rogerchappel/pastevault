# Agent Operating Instructions for pastevault

This file defines how AI agents and human maintainers should work in `pastevault`.

## Project Context

- Project: `pastevault`
- Repository: `https://github.com/rogerchappel/pastevault` (`rogerchappel/pastevault`)
