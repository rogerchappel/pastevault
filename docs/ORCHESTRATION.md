# ORCHESTRATION: pastevault

Owner: one isolated project sub-agent.
Workspace: /Users/roger/Developer/my-opensource/pastevault only.
...
## Publish
- Create public GitHub repo: https://github.com/rogerchappel/pastevault
- Push main directly when verified.
- Configure repo description and topics.
- Run /Users/roger/.openclaw/workspace/scripts/protect-github-main.sh rogerchappel pastevault main if available.
